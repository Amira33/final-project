   ...
   //*****************************************************************//
    ...
    public void actionPerformed(ActionEvent e) {  //implement ActionListener
       ...
       switch (e.getActionCommand()) {
        ...
        case "SaveFile" -> {                 // save Data file from table in CSV file
           
            SaveFile();
            }   
            
        case "LoadFile" ->                 // Load CSV file in table
           {
               try {
                   LoadFile() ;
    ...
    //****************************************************************//   
        ...
        case "CreatenewInvoice " -> {       // to create nev invoice with num and date and name 
    ...
    private void LoadFile() throws FileNotFoundException, IOException, ParseException {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            File headerFile = openFile.getSelectedFile();
             try {
                FileReader headerFr = new FileReader(headerFile);          // READ FILE
                BufferedReader headerBr = new BufferedReader(headerFr);
                String headerItem = null;

                while ((headerItem = headerBr.readLine()) != null) {
                    String[] headerSegments = headerItem.split(",");    // to split invoices OF HEADER
                    String invoiceNumberStr = headerSegments[0];       // invoiceNumber string
                    String invoiceDateStr = headerSegments[1];        // invoiceDate string
                    String customerName = headerSegments[2];         // customerName already string
